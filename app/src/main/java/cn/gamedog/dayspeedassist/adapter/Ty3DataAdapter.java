 ...
 */
public class Ty3DataAdapter extends RecyclerView.Adapter<Ty3DataAdapter.ItemViewHolder> {
    private List<Itemdata> data;
    private Context context;

    public  Ty3DataAdapter(Context context, List<Itemdata> list) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.ty3_item, parent, false);
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        holder.loadTitle(itemdata.getTitle());
