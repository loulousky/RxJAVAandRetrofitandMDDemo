 ...
 */
public class ItemDataBaseAdapter extends RecyclerView.Adapter<ItemDataBaseAdapter.ItemViewHolder> {


    private List<Itemdata> data;
    private Context context;

   public  ItemDataBaseAdapter(Context context, List<Itemdata> list) {
