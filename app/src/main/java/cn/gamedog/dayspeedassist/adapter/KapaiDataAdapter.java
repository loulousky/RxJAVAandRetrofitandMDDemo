 ...
 */
public class KapaiDataAdapter extends  RecyclerView.Adapter<KapaiDataAdapter.ItemViewHolder>{

    private List<Itemdata> data;
    private Context context;

    public  KapaiDataAdapter(Context context, List<Itemdata> list) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.kapai_item, parent, false);
